        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-card-foreground font-medium bg-gray-950">Accuracy Rate</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-secondary mb-2">10k+</div>
              <div className="text-card-foreground font-medium bg-gray-950">Claims Processed</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-accent mb-2">24/7</div>
              <div className="text-card-foreground font-medium bg-gray-950">AI Assistant</div>
            </div>
          </div>
        </div>
      </section>
