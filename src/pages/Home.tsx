...
import { Upload, CheckCircle, FileCheck, TrendingUp, Users, BookOpen, MessageSquare, Info, Shield, Zap, Heart } from "lucide-react";
...
const Home = () => {
  ...
  return <div className="min-h-screen pt-16 relative">
      {/* Home Page Background */}
      <div className="fixed inset-0 bg-cover bg-center bg-no-repeat opacity-8 dark:opacity-5 -z-10" style={{
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 dark:from-primary/5 dark:via-secondary/5 dark:to-accent/5">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-foreground mb-8 max-w-3xl mx-auto animate-fade-in-up" style={{
            animationDelay: "0.2s"
          }}>
            ...
            animationDelay: "0.4s"
              ...
              <Button size="lg" className="bg-gradient-to-r from-primary to-secondary hover:scale-105 transition-transform" onClick={() => navigate("/upload-policy")}>
                <Zap className="mr-2 h-5 w-5" />
                Get Started
              </Button>
              <Button variant="outline" size="lg" className="hover:scale-105 transition-transform" onClick={() => navigate("/about")}>
                Learn More
              </Button>
            </div>
          </div>
      ...
      <section className="py-24 bg-background/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            return <Card key={feature.title} className="feature-card group cursor-pointer animate-card-reveal" onClick={() => navigate(feature.href)} style={{
              animationDelay: `${index * 0.1}s`
                  ...
                  <CardContent className="p-6 h-full flex flex-col">
                    ...
                    <Button variant="ghost" size="sm" className="mt-auto w-full group-hover:bg-primary/15 group-hover:text-primary group-hover:shadow-md transition-all duration-300 hover-lift">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-muted-foreground dark:text-card-foreground font-medium">Accuracy Rate</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-secondary mb-2">10k+</div>
              <div className="text-muted-foreground dark:text-card-foreground font-medium">Claims Processed</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-accent mb-2">24/7</div>
              <div className="text-muted-foreground dark:text-card-foreground font-medium">AI Assistant</div>
            </div>
          </div>
        </div>
      </section>
